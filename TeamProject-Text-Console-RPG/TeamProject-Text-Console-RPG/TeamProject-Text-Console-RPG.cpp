...
void MainGame::ShowShopPage()
{
    ...
    while (true)
    {
        ...
        std::cout << "=================================================" << std::endl;
        std::cout << "상점에 입장하셨습니다." << std::endl;
        std::cout << "원하시는 행동을 선택하세요." << std::endl;
        std::cout << "=================================================" << std::endl;
...
void MainGame::ShowInventoryPage(Character* player)
{
    while (true)
    {
        ...
        std::cout << "=================================================" << std::endl;
        std::cout << "인벤토리를 엽니다." << std::endl;
        std::cout << "원하시는 행동을 선택하세요." << std::endl;
        std::cout << "=================================================" << std::endl;
        std::cout << "1. 아이템 사용" << std::endl;
        std::cout << "2. 장비 확인 / 교체" << std::endl;
        std::cout << "3. 상태 확인" << std::endl;
        std::cout << "0. 메인으로 돌아가기" << std::endl;
        std::cout << "=================================================" << std::endl;
        std::cout << "입력 : ";
...
void MainGame::RandomUseItem()
{
    ...
    std::cout << "=================================================" << std::endl;
    std::cout << itemName << "을(를) 성공적으로 사용했습니다!" << std::endl;
...
void MainGame::ShowMainPage()
{
    ...
    std::cout << "=================================================" << std::endl;
    std::cout << "마을에 진입하셨습니다." << std::endl;
    std::cout << "원하시는 행동을 선택하세요." << std::endl;
    std::cout << "게임을 종료하려면 0을 입력하세요." << std::endl;
    std::cout << "=================================================" << std::endl;
    std::cout << "1. 사냥터로 이동" << std::endl;
    std::cout << "2. 인벤토리 열기" << std::endl;
    std::cout << "3. 상점 가기" << std::endl;
    std::cout << "4. 상태 확인" << std::endl;
    std::cout << "=================================================" << std::endl;
    std::cout << "입력 : ";
}